            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-messages">
                    ...
                    <li>
                        <a href="#">
                            <div>
                                <strong><span class=" label label-success">Admin</span></strong>
                                <span class="pull-right text-muted">
                                        <em>Yesterday</em>
                                    </span>
                            </div>
            ...
            <ul class="nav" id="side-menu">
                <li>
                    ...
                    <div class="user-section">
                        ...
                        <div class="user-info">
                            <div>Admin <strong>Huy</strong></div>
                ...
                <li class="@if($currentPath =='')selected @endif">
                    <a href="{{url('admin')}}"><i class="fa fa-dashboard fa-fw"></i>Dashboard</a>
                </li>
                {{--ham neu bam cao category thi them selected va chuyen mau--}}
                <li class="@if(starts_with($currentPath,'category'))selected @endif">
                    <a href="{{url('admin/category')}}"><i class="fa fa-flask fa-fw"></i>Category</a>
                </li>
                <li class="@if(starts_with($currentPath,'image'))selected @endif">
                    <a href="{{url('admin/image')}}"><i class="fa fa-flask fa-fw"></i>Image</a>
                </li>
                <li>
